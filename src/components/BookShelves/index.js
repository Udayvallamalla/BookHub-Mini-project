  ...
  renderBooksFailureView = () => (
    <div className="top-rated-books-failure-container">
      <img
        ...
        src="https://res.cloudinary.com/dkxxgpzd8/image/upload/v1647843563/connection-lost_rtafzx.webp"
        alt="failure view"
      />
    ...
    return (
      <div className="no-match-found-container">
        <img
          ...
          src="https://res.cloudinary.com/dkxxgpzd8/image/upload/v1647843584/not-find_kjexhy_ljnhrg.png"
          alt="no books"
        />
